            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title">{{trans('admin.contact us')}}</h5>
                        <ol class="breadcrumbs">
                            <li><a href="{{url('/')}}">{{trans('admin.dashboard')}}</a></li>
                            <li class="active">{{trans('admin.contact us')}}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="card-panel">
                            <h4 class="header2">{{trans('admin.contact us')}}</h4>
                            <div class="row">
                                ...
                                @endif
                                <form class="col s12" method="post" action="{{route('store_contact')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input id type="text" name="contact_subject" value="{{ old('contact_subject') }}" required>
                                            <label>{{trans('admin.subject')}}</label>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <input type="text" name="contact_message" value="{{ old('contact_message') }}" required>
