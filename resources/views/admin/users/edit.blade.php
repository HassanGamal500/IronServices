            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title">{{trans('admin.edit user')}}</h5>
                        <ol class="breadcrumbs">
                            <li><a href="index.html">{{trans('admin.dashboard')}}</a></li>
                            <li class="active">{{trans('admin.edit user')}}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="card-panel">
                            <h4 class="header2">{{trans('admin.edit user')}}</h4>
                            <div class="row">
                                ...
                                @endif
                                <form class="col s12" method="post" action="{{route('update_user', $users->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
