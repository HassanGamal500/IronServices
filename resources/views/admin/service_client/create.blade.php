...
@section('page_title')
    {{trans('admin.add')}} {{getServiceName($id)->service_name}}
@endsection
@section('content')
    <section id="content">
        <!--breadcrumbs start-->
            ...
            <div class="container">
                <div class="row">
                    <div class="col s10 m6 l6">
                        <h5 class="breadcrumbs-title">{{trans('admin.add')}} {{getServiceName($id)->service_name}}</h5>
                        <ol class="breadcrumbs">
                            <li><a href="{{url('/')}}">{{trans('admin.dashboard')}}</a></li>
                            <li class="active">{{trans('admin.add')}} {{getServiceName($id)->service_name}}</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col s12">
                        <div class="card-panel">
                            <h4 class="header2">{{trans('admin.add')}} {{getServiceName($id)->service_name}}</h4>
                            <div class="row">
                                ...
                                @endif
                                <form class="col s12" method="post" action="{{route('store_service_client')}}" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col s2">
                                            <img id="image_preview_container" src="{{ asset('image/user_avatar.png') }}"
                                    ...
                                    <div class="row">
                                        <div class="input-field col s12">
                                            <i class="material-icons prefix">account_circle</i>
                                            <input id="name4" type="text" pattern="^[.0-9]+$" name="percentage" value="{{ old('percentage') }}" required>
                                    ...
                                    <div class="row">
                                        <div class="file-field input-field col s10">
                                            <div class="btn">
                                                ...
                                                <input type="file" name="logo" id="image-logo" required>
                                            </div>
                                            <div class="file-path-wrapper">
                                                <input class="file-path validate"  type="text">
                                            </div>
                                        ...
                                        <div class="col s2">
                                            <img id="image_preview_container_logo" src="{{ asset('image/user_avatar.png') }}"
                                                 alt="preview image" style="max-height: 100px;">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s2">
                                            ...
                                            <i class="material-icons prefix">account_circle</i>
                                            <input id="name" type="color" name="color" value="{{ old('color') }}" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="input-field col s12">
